...
// Asset Imports (Add your banner import here)
...
export default function ReadyToEatLayout({ children }: { children: React.ReactNode }) {
  ...
  // Logic to sync sidebar and breadcrumbs with the URL
  const activeCategory = categories.find(cat => pathname.includes(cat.path)) || categories[0];

  // Handle sorting via URL query parameters
        ...
        <div className="container mx-auto px-4 md:px-10">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center min-h-[80px] md:h-[105px] py-4 md:py-0 gap-4">
            ...
            <nav aria-label="Breadcrumb" className="flex flex-wrap items-center gap-2 text-[1rem] text-[#002147] font-serif">
              ...
              <Link href="/ready-to-eat/cup-meal" className="hover:text-[#CD9951] transition-colors whitespace-nowrap">Ready to Eat</Link>
              <span className="text-gray-400">›</span>

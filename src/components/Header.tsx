...
// --- API Handlers for Search Result Interactions ---
...
<button onClick={() => updateQuantity(item.product._id, item.quantity - 1)} className="p-1 px-2.5 hover:bg-black/10"><Minus size={12} /></button>
<span className="px-2 text-sm font-bold">{item.quantity}</span>
<button onClick={() => updateQuantity(item.product._id, item.quantity + 1)} className="p-1 px-2.5 hover:bg-black/10"><Plus size={12} /></button>
</div>
...
<button className="border border-gray-200 p-1.5 rounded-md text-[#711A2E] hover:bg-gray-50" onClick={(e) => e.stopPropagation()}>
<Heart size={16} />
</button>
</div>
</div>
